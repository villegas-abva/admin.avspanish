...
class AddQuizCRScreen extends StatefulWidget {
  ...
  @override
  _AddQuizCRScreenState createState() => _AddQuizCRScreenState();
}

class _AddQuizCRScreenState extends State<AddQuizCRScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AddQuizCRScreen.primColor,
      body: Form(
        key: _formKey,
        child: Padding(
      ...
      floatingActionButton: FloatingActionButton(
          ...
          child: Icon(
            Icons.add,
            color: AddQuizCRScreen.primColor,
          ),
          onPressed: () async {
            // validate form
            if (_formKey.currentState!.validate()) {
              ...
              if (questionIndex < 9) {
                ...
                bool questionWasAdded = await AddQuizService().addCRQuestion(
